...
1. Create the exclusive `temple-wave-5a-lab-r4` root.
2. Run all eleven quote-aware replay scenarios and the validation-program tests locally.
3. Run `run-wave-5a.mjs --preflight-only` against WI-0112 and its new approval record.
