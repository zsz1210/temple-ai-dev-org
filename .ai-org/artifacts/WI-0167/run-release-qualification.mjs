...
const CANDIDATE_REVISION = "6a8760f9669c58085b069e91776b89d0a857fc83";
...
async function qualify() {
  ...
  try {
    ...
    return {
      schema_version: "temple.alpha30-release-qualification/v1",
      ...
      retained_limits: [
        "The clean consumer uses the exact prepublication tarball so registry state cannot change the qualification input.",
        ...
        "Publication is authorized only for this exact version, GitHub prerelease, public npm access, and the next dist-tag."
      ]
    };
  } finally {
