...
Stop after the bounded Work Item is accepted and both `temple status` and `temple doctor` are healthy. Report:

- disposable project path and final Git revision;
...
Do not start the cold-recovery session and do not add more product features.
