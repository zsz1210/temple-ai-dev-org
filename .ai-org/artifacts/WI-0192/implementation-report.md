...
- A failed native spawn closes its tool record without inventing a child, allowing parent terminal observation. Only allowlisted machine error categories and a digest are retained; unrecognized/missing provider error details stay unknown.
