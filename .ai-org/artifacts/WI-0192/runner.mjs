...
export async function execute(lab,approvalPath,reviewPath){
 throw Error('successor-live-disabled-pending-fresh-review-and-approval');
 /* Retained orchestration below is not an executable live approval. */
