...
- **必要な文脈だけを渡す：** 現在の Position と作業に必要な仕様、判断、Skill、検証記録へ案内します。
...
- **現在利用できるもの：** リポジトリ中心の Solo ワークフロー、安定した Position、Work Item、決定的なコンテキスト・Capability ルーティング、管理された Skill と学習、ライフサイクル証拠、ローカル状態確認、アップグレード境界。
- **実験中または限定的なもの：** Collaborative と High-Assurance の契約、並行計画、Provider の観測、ローカル Control Plane、外部トラッカー連携、Work Item 単位の使用量帰属。
