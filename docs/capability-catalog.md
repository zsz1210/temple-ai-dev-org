...
AiPet is the next portability pilot and will identify which candidate deserves the first optional pack. Phase 1.5 will exercise `domain-modeling` during a greenfield Project Charter and first vertical slice.
