...
| --- | --- | --- | --- | --- |
| Position-to-Position handoff is retained in repository state | Demonstrated | [Temple self-host dogfood](alpha-23-temple-self-host-dogfood.md) and canonical Work Item handoffs | Scope, evidence, revision, and next responsibility can live in the repository instead of only a chat title | One maintainer and one machine; this does not prove a conversation boundary or that another person understood the handoff |
