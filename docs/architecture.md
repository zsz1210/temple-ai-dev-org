...
| Generated | `.ai-org/views/**`, including status, Capability Registry, tracker observations and plans, and work-item Context Capsules | CLI/Observer | Rebuildable from canonical state |
